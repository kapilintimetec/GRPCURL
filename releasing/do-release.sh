...
$PREFIX docker buildx build --platform linux/amd64,linux/s390x,linux/arm64,linux/ppc64le --tag kapilintimetec/grpcurl:${VERSION} --tag kapilintimetec/grpcurl:latest --push --progress plain --no-cache .
rm VERSION

# Homebrew release

URL="https://github.com/kapilintimetec/grpcurl/archive/${VERSION}.tar.gz"
