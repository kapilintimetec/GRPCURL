# gRPCurl
[![Build Status](https://circleci.com/gh/kapilintimetec/grpcurl/tree/master.svg?style=svg)](https://circleci.com/gh/kapilintimetec/grpcurl/tree/master)
[![Go Report Card](https://goreportcard.com/badge/github.com/kapilintimetec/grpcurl)](https://goreportcard.com/report/github.com/kapilintimetec/grpcurl)
...
This repo also provides a library package, `github.com/kapilintimetec/grpcurl`, that has
...
Download the binary from the [releases](https://github.com/kapilintimetec/grpcurl/releases) page.
...
```shell
# Download image
docker pull kapilintimetec/grpcurl:latest
# Run the tool
docker run kapilintimetec/grpcurl api.grpc.me:443 list
```
...
```shell
go install github.com/kapilintimetec/grpcurl/cmd/grpcurl@latest
```
